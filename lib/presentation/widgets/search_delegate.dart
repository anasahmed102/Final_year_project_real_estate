...
//   final Stream<List<RealEstateModel>> realEstateStream;
...
//               .where((realEstate) => (realEstate['properyName'] as String)
//                   .toLowerCase()
...
//               return ListTile(
//                 title: Text(results[index]['properyName'].toString()),
//                 onTap: () {
//                   close(context, results[index]['properyName'].toString());
//                 },
//               );
//             },
//           );
